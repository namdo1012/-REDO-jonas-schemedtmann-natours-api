...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var alertDiv = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', 'You are now logged in!'); // REDIRECT to overview page after 1.5s
          ...
          case 7:
            ...
            console.log('Login function: ', _context.t0);
            (0, _alert.showAlert)('error', 'Error logging in! Try again.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            console.log('Err from Logout func: ', _context.t0.response);
...
var updateSetting = /*#__PURE__*/function () {
  ...
  return function updateSetting(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var updatePassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(currentPassword, newPassword, newPasswordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // Note: Must to pass form class to function instead of values of name, email or photo
    // Because axios automatically realize form class is multipart-form-data

    (0, _updateSetting.updateSetting)(form);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updatePassword.updatePassword)(currentPassword, newPassword, newPasswordConfirm);
